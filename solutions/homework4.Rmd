...
- $t_2(\text{M} \rightarrow \text{M}) = \frac{0+1}{(0+1)+(3+1)+(0+1)}= \frac{1}{6}$.  
- $t_2(\text{M} \rightarrow \text{I}) = \frac{3+1}{(0+1)+(3+1)+(0+1)}= \frac{2}{3}$.  
- $t_2(\text{M} \rightarrow \text{D}) = \frac{0+1}{(0+1)+(3+1)+(0+1)}= \frac{1}{6}$.  
- $t_2(\text{I} \rightarrow \text{M}) = \frac{0+1}{(0+1)+(0+1)+(0+1)}= \frac{1}{3}$.  
- $t_2(\text{I} \rightarrow \text{I}) = \frac{0+1}{(0+1)+(0+1)+(0+1)}= \frac{1}{3}$.  
- $t_2(\text{I} \rightarrow \text{D}) = \frac{0+1}{(0+1)+(0+1)+(0+1)}= \frac{1}{3}$.  
